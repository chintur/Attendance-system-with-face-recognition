...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"F:\Project\Python_Test_Projects\Images_GUI\bgReg.jpg")
        ...
        # img1=Image.open(r"F:\Project\Python_Test_Projects\Images_GUI\reg1.png")
