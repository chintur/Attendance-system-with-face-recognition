...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"F:\Project\Python_Test_Projects\Images_GUI\web.png")
        ...
        det_img_btn=Image.open(r"F:\Project\Python_Test_Projects\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"F:\Project\Python_Test_Projects\Images_GUI\yt.png")
        ...
        hlp_img_btn=Image.open(r"F:\Project\Python_Test_Projects\Images_GUI\gmail.png")
